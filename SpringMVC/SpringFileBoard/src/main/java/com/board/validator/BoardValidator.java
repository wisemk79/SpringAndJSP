...
public class BoardValidator implements Validator { //MemberValidator
	...
	public void validate(Object target, Errors errors) {
        ...
        ValidationUtils.rejectIfEmptyOrWhitespace(errors,"writer","required");//required.writer
        ValidationUtils.rejectIfEmptyOrWhitespace(errors,"title","required");//required.title
        ValidationUtils.rejectIfEmptyOrWhitespace(errors,"content","required");//required.content
	}
}
